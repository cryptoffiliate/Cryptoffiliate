...
export default function HomePage() {
  return (
    <div data-testid="home-page">
          ...
          <div className="grid-hero">
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <h1
                ...
                style={{ marginBottom: "22px", color: "#111111" }}
              ...
              <p className="body-lg animate-fade-up delay-200" style={{ marginBottom: "36px", maxWidth: "540px", fontSize: "18px", color: "#4A4A4A" }}>
                Live fee data, unbiased reviews, and an <strong style={{ color: "#FF5722" }}>AI advisor</strong> that tells you the truth — not whoever pays the highest commission.
              </p>
              ...
              >
                {STATS.map(({ num, label }, i) => (
                  <div
                    ...
                    style={{
                      padding: "18px 14px",
                      borderRight: i < STATS.length - 1 ? "2px solid #111111" : "none",
                    }}
                  >
                    <p
                      style={{
                    ...
                    <p style={{ fontFamily: "var(--font-mono)", fontSize: "9px", color: "#4A4A4A", letterSpacing: ".18em", fontWeight: 600, textTransform: "uppercase" }}>
                      {label}
                    </p>
                  </div>
                ))}
      ...
      {/* ── Live exchange table ───────────────────────────────── */}
      <section
        style={{ borderBottom: "2px solid #111111", background: "#F4F4F0" }}
          ...
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "32px", flexWrap: "wrap", gap: "16px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap" }}>
              <span style={{ display: "inline-flex", alignItems: "center", gap: 8 }}>
                ...
                <span style={{ fontFamily: "var(--font-mono)", fontSize: "11px", color: "#4A4A4A", fontWeight: 600, letterSpacing: ".1em", textTransform: "uppercase" }}>
                  Fees synced tonight
                </span>
              </span>
      ...
      {/* ── AI Features grid ──────────────────────────────────── */}
      <section
        style={{ borderBottom: "2px solid #111111", background: "#FFFFFF" }}
            ...
            {AI_FEATURES.map(({ num, title, desc, tag, accentBg, accentText }, i) => (
              <div
                ...
                style={{
                  ...
                  gap: "10px",
                  minHeight: "230px",
                  borderRight: (i + 1) % 3 !== 0 ? "2px solid #111111" : "none",
              ...
              >
                ...
                <p style={{ fontFamily: "var(--font-display)", fontSize: "16px", fontWeight: 800, color: "#111111", marginTop: "8px", letterSpacing: "-.01em" }}>
                  {title}
                </p>
                <p style={{ fontFamily: "var(--font-body)", fontSize: "13.5px", color: "#4A4A4A", lineHeight: 1.6 }}>
                  {desc}
                </p>
              </div>
            ))}
          ...
          >
            {VERTICALS.map(({ href, num, title, desc, accentColor }, i) => (
              <Link
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLElement).style.background = "#F4F4F0";
                  (e.currentTarget as HTMLElement).style.boxShadow = `inset 4px 0 0 ${accentColor}`;
                }}
                onMouseLeave={(e) => {
              ...
              >
                ...
                <p style={{ fontFamily: "var(--font-body)", fontSize: "14px", color: "#4A4A4A", lineHeight: 1.55, flex: 1 }}>
                  {desc}
                </p>
                <p style={{ fontFamily: "var(--font-mono)", fontSize: "11px", color: "#111111", fontWeight: 700, letterSpacing: ".12em", textTransform: "uppercase", marginTop: "auto" }}>
                  Explore →
                </p>
              </Link>
            ))}
      ...
      <section style={{ borderBottom: "2px solid #111111", background: "#111111" }}>
        <div className="container" style={{ paddingTop: "88px", paddingBottom: "88px" }}>
          <div style={{ maxWidth: "920px" }}>
            <p style={{ fontFamily: "var(--font-mono)", fontSize: "10px", letterSpacing: ".25em", color: "#FF5722", textTransform: "uppercase", marginBottom: "22px", fontWeight: 700 }}>
              § 04 — Editor&apos;s Note
            </p>
            <p
              style={{
            ...
            <p style={{ fontFamily: "var(--font-mono)", fontSize: "11px", letterSpacing: ".15em", color: "#555555", textTransform: "uppercase", marginTop: "30px", fontWeight: 600 }}>
